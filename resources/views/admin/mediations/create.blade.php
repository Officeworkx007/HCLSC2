...
@section('content')
    <div class="min-h-[80vh] flex items-center justify-center py-10 px-4 bg-gray-50">
        <div class="w-full max-w-3xl bg-white rounded-2xl shadow-xl p-8 sm:p-10 border border-gray-200">
            ...
            <form action="{{ route('admin.mediations.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-8">
                @csrf
                ...
                <div>
                    ...
                    <input type="date" name="cause_list_date"
                        value="{{ old('cause_list_date', now()->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <input type="date" name="to_be_held_on" id="to_be_held_on" required
                        value="{{ old('to_be_held_on') }}"
                        class="w-full rounded-xl border border-gray-300 bg-gray-50 text-gray-900 p-3
                ...
                <div>
                    ...
                    <div
                        class="flex flex-col sm:flex-row items-center gap-4 bg-gray-100 p-4 rounded-xl border border-gray-200">
