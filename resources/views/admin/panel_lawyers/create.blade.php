    ...
    <div class="max-w-6xl mx-auto p-4 md:p-8 bg-white shadow-xl rounded-2xl">
        ...
        <form action="{{ route('admin.panel_lawyers.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div
                    class="lg:col-span-1 flex flex-col items-center p-6 bg-gray-50 border border-gray-200 rounded-xl h-fit sticky top-6">
                    <h3 class="text-lg font-semibold text-gray-700 mb-4">Lawyer Photo</h3>

                    {{-- Photo Frame --}}
                    <div id="photo-frame"
                        class="w-48 h-48 border-4 border-dashed border-gray-300 rounded-xl flex items-center justify-center overflow-hidden mb-4 relative hover:border-indigo-500 transition-colors cursor-pointer">
                        ...
                        <span id="upload-icon" class="text-gray-400 text-6xl">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M6.827 6.175A2.31 2.31 0 0 1 5.186 7.23c-.38.054-.757.112-1.134.175M4.833 9.407A2.08 2.08 0 0 0 3.39 12m0 0a2.08 2.08 0 0 0 1.444 2.593m0 0c.38.054.757.112 1.134.175M4.833 9.407A2.08 2.08 0 0 1 3.39 12m0 0a2.08 2.08 0 0 0 1.444 2.593c.48.07.957.135 1.44.195M12 21.75c-4.97 0-9-4.03-9-9s4.03-9 9-9c1.928 0 3.7.625 5.167 1.684M12 21.75c4.97 0 9-4.03 9-9s-4.03-9-9-9m0 16.5v-15.75" />
                            </svg>
                        </span>
                    </div>
                    ...
                    <label for="photo"
                        class="cursor-pointer px-4 py-2 bg-indigo-500 text-white font-medium rounded-lg shadow-md hover:bg-indigo-600 transition">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                        ...
                        <div>
                            <label for="enrolment_no" class="block text-sm font-medium text-gray-700 mb-1">Bar Enrolment
                                Number</label>
                            <input type="text" id="enrolment_no" name="enrolment_no" value="{{ old('enrolment_no') }}"
                                class="w-full border-gray-300 rounded-lg px-4 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition @error('designation') border-red-500 @enderror" />
                            @error('enrolment_no')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                            @enderror
            ...
            fileInput.addEventListener('change', function(event) {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        ...
                        'border-dashed'); // Make the frame solid once an image is uploaded
                    };
