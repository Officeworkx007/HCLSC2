    ...
    <form action="{{ route('homepage.legalaid.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="page-container bg-white shadow-lg rounded-xl overflow-hidden">
                ...
                <div id="formContainer1" class="collapsible px-6 py-6 space-y-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="name" class="block text-sm mb-1">Applicant Name *</label>
                        ...
                        <div>
                            <label for="spouse_name" class="block text-sm mb-1">Spouse Name</label>
                        ...
                        <div>
                            <label for="number" class="block text-sm mb-1">Phone Number</label>
                        ...
                        <div>
                            <label for="religion" class="block text-sm mb-1">Religion</label>
                        ...
                        <div>
                            <label for="caste" class="block text-sm mb-1">Caste</label>
                        ...
                        <div>
                            <label for="income" class="block text-sm mb-1">Annual Income</label>
                        ...
                        <div>
                            <label for="eligibility_category" class="block text-sm mb-1">Eligibility Category</label>
        ...
        <section class="flex justify-center py-6">
            <div class="page-container bg-white shadow-lg rounded-xl overflow-hidden">
                ...
                <!-- Collapsible Section -->
                <div id="formContainer2" class="collapsible hidden px-6 py-6 space-y-6">
